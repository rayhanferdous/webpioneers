...
const Card = forwardRef(({ tag, image = '/blogs/blog-default-thumb.png', title, desc, minsToRead, link }, ref) => {
    return (
        <div
            ref={ref}
            className="font-urbanist relative border-2 border-[#686868] rounded-[18px] h-full"
        >
