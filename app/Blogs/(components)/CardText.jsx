...
const CardText = ({ colSpanTwo, title, desc, minsToRead, link = "/#" }) => {
    return (
        <div className={`${colSpanTwo && 'md:absolute md:bottom-9 md:left-9 md:bg-white max-w-[400px] 2xl:max-w-[549px] rounded-2xl'} p-6 flex flex-col gap-[18px] md:gap-6 lg:gap-4 2xl:gap-9`}>
            ...
            <div className="flex items-center justify-between">
                ...
                <Link href={link}>
                    <svg width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M17.4297 25H31.5718M31.5718 25L24.5008 17.9289M31.5718 25L24.5008 32.0711" stroke="white" stroke-width="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                </Link>
            </div>
        </div>
