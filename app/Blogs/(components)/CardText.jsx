...
const CardText = ({ colSpanTwo, title, desc, minsToRead, link = "/#" }) => {
    return (
        <div className={`${colSpanTwo && 'min-[1024px]:absolute min-[1024px]:bottom-9 min-[1024px]:left-9 min-[1024px]:bg-white max-w-[400px] 2xl:max-w-[549px] rounded-2xl'} p-6 flex flex-col gap-[18px] md:gap-6 lg:gap-4 2xl:gap-9`}>
