...
const CardText = ({ colSpanTwo, title, desc, minsToRead, link = "/#" }) => {
    return (
        <div className={`${colSpanTwo ? 'min-[1370px]:absolute md:bottom-9 md:left-9 min-[1370px]:bg-white min-[1370px]:max-w-[400px] 2xl:max-w-[549px] rounded-2xl' : ''} p-6 flex flex-col     justify-between gap-4`}>
