...
const Comp1 = React.memo(({ isInView }) => {
  ...
  return (
    ...
    >
      ...
      <div className="max-[2399px]:mt-auto px-4 sm:px-8 py-8 lg:py-14 flex flex-col gap-2 min-[2400px]:h-full">
        <h3 className="text-xl sm:text-[1.5rem] lg:text-[1.85rem] min-[2400px]:h-full min-[2400px]:flex min-[2400px]:items-center leading-snug text-gray-500 lg:text-gray-900 font-medium">
