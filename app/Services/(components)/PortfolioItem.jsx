...
import InfiniteMarquee from "@/app/(components)/ui/InfiniteMarquee";
...
const PortfolioItem = ({
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="aspect-square w-full overflow-hidden bg-white/10 border-2 border-gray-700"
        ...
        <MountAnim className="flex flex-col gap-2">
          ...
          <h2 className="mt-2 text-[1.75rem] sm:text-4xl leading-none">
            {item.title}
          </h2>
          <p className="text-lg sm:text-[1.65rem] lg:text-[1.375rem] leading-snug text-gray-700">
            {item.detail}
          </p>
        </MountAnim>
      </motion.div>
